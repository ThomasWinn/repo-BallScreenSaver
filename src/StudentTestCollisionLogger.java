    ...
    public void TestCollisionEverywhereUnequal() {
        ...
        for (int i = 0; i < actual.length; i++) {
            for (int j = 0; j < actual[i].length; j++) {
                ...
                assertEquals("Logger did not normalize correctly when collisions occurred everywhere, unequally"+i+"+"+j, expected, actual[i][j], tolerance);
            }
        }
    }
    ...
    public void TestCollisionHalfMap() {
        ...
        for (int i = 0; i < actual.length; i++) {
            for (int j = 0; j < actual[i].length; j++) {
                ...
                assertEquals("Logger did not normalize correctly when collisions only occurred in a part of the screen saver "+ i+':'+j, expected, actual[i][j], tolerance);
            }
        }
    }
